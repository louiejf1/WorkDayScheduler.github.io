...
$(document).ready(function () { //JQuery - Document ready start
      ...
      console.log(info);
            ...
            $("#hour-8").val(localStorage.getItem('9 AM'));
            $("#hour-8").val(localStorage.getItem('10 AM'));
            $("#hour-8").val(localStorage.getItem('11 AM'));
            $("#hour-8").val(localStorage.getItem('12 AM'));
            $("#hour-8").val(localStorage.getItem('1 AM'));
            $("#hour-8").val(localStorage.getItem('2 AM'));
            $("#hour-8").val(localStorage.getItem('3 AM'));
            $("#hour-8").val(localStorage.getItem('4 AM'));
            $("#hour-8").val(localStorage.getItem('5 AM'));
            $("#hour-8").val(localStorage.getItem('6 AM'));
